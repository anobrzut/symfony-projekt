 ...
 */
final class Version20240912052311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contacts (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, phone VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_33401573F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contacts_tags (contacts_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_6FDD317F719FB48E (contacts_id), INDEX IDX_6FDD317FBAD26311 (tag_id), PRIMARY KEY(contacts_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contacts_tags ADD CONSTRAINT FK_6FDD317F719FB48E FOREIGN KEY (contacts_id) REFERENCES contacts (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacts_tags DROP FOREIGN KEY FK_6FDD317F719FB48E');
